...
(lib.run_hand_simple_tap_hold = function() {
	...
	this.shape.graphics.f().s("#FFFFFF").ss(5).p("");
...
(lib.run_hand_simple_tap = function() {
	...
	// Calque 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(5).p("");
...
(lib.jumping = function() {
	...
	// Calque 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(5,1).p("AiRCGQAqhLAyhiAAUgTIhGCCAh/iFQB5AmCYAO");
...
(lib.decor_run_intro_motion = function() {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFFFFF").ss(5,1,1).p("A4cAAMAxCAAAEhrQAAAMBFPAAAEAiIAAAMBJJAAA");
...
(lib.exit_button = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_2}]},6).to({state:[{t:this.shape_1},{t:this.shape}]},34).to({state:[{t:this.instance_3}]},16).to({state:[{t:this.instance_3}]},14).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.shape_3},{t:this.shape_2}]},26).to({state:[{t:this.instance_3}]},15).to({state:[{t:this.instance_3}]},25).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_2}]},27).to({state:[{t:this.instance_2}]},27).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).to({_off:true},34).wait(31).to({_off:false},0).to({_off:true},26).wait(41).to({_off:false,x:-30.9},0).wait(27).to({x:-210.1},27).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(6).to({_off:false},0).to({x:-392.9},34).wait(16).to({x:-762.9},41).wait(41).to({x:-1022.9},27).wait(28));
...
(lib.intro_run_motion = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(189).call(this.frame_189).wait(4));
