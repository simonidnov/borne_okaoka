...
(lib.picots_run_motion = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{choice_0:87,choice_1:101});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(84).call(this.frame_84).wait(9).call(this.frame_93).wait(14).call(this.frame_107).wait(132));

	// Calque 4
	this.instance = new lib.fail_water("synched",6,false);
	this.instance.setTransform(106.3,132.5,1,1,0,0,0,8.6,-27.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},230).wait(9));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(176,97.6,424,200);
