...
(lib.watter_pool = function() {
	...
	this.shape.graphics.f().s("#FFFFFF").ss(2,1).p("");
...
(lib.fail_water = function(mode,startPosition,loop) {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_1.setTransform(136.6,33);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_2.setTransform(129.1,28.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_3.setTransform(121.6,21.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#FFFFFF").ss(2,1).p("");
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_8.setTransform(106.6,26.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#FFFFFF").ss(2,1).p("");
	...
	this.shape_11.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_11.setTransform(91.6,29.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_12.setTransform(91.6,26.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_13.setTransform(91.6,21.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_14.setTransform(91.6,11);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_15.setTransform(91.6,5.8);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_16.setTransform(91.6,1.3);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#FFFFFF").ss(2,1).p("");
	this.shape_17.setTransform(91.6,-2.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#FFFFFF").ss(2,1).p("");
	...
	this.shape_20.graphics.f().s("#FFFFFF").ss(2,1).p("");
	...
	this.shape_23.graphics.f().s("#FFFFFF").ss(5,1).p("AAABTQAAAAAAAAIB6hXQATgPAZAEQAZAEAOASIA6BPIAEAFAgVgZQgwAZgaAsAjABrQhkhjAjhy");
...
(lib.picots_run_motion = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
