...
(lib.running_motion_3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{end:160});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(160).call(this.frame_160).wait(85));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(25).to({_off:false},0).to({_off:true},1).wait(219));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(25).to({_off:false},0).to({_off:true},1).wait(219));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(25).to({_off:false},0).to({_off:true},1).wait(219));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(25).to({_off:false},0).to({_off:true},1).wait(219));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(26).to({_off:false},0).to({x:1643.9},77).to({_off:true},1).wait(141));
	...
	this.instance_4 = new lib.walking_06("synched",0);
	this.instance_4.setTransform(-604.9,204.2,0.625,0.625,0,0,0,-10.4,-29.8);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3},{t:this.instance_2}]}).to({state:[]},26).to({state:[{t:this.instance_4}]},35).to({state:[{t:this.instance_4}]},99).to({state:[]},1).to({state:[]},83).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(61).to({_off:false},0).to({x:2155.1,mode:"independent"},99).to({_off:true},1).wait(84));

	// Calque 9
	this.instance_5 = new lib.monsieurcircle_walk("synched",0);
	this.instance_5.setTransform(-845.2,222.4,0.887,0.887,0,0,180,-3.2,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(61).to({_off:false},0).to({x:1899.4,y:230},99).to({_off:true},1).wait(84));

	// Calque 10
	this.instance_6 = new lib.monsieurcarre("synched",34);
	this.instance_6.setTransform(-729.7,220.6,0.922,0.922,0,0,180,-3.3,0);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(61).to({_off:false},0).to({x:2017.9,y:222.2},99).to({_off:true},1).wait(84));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_3).to({_off:true},25).wait(220));
