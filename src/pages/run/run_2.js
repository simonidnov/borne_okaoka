...
run.prototype.preload = function(){
    ...
    self.game.load.image('fl_ph', 'pages/run/maps/small_maps/fl.png');
    self.game.load.image('fl_ph_f', 'pages/run/maps/small_maps/fl_f.png');
    self.game.load.image('fl_ph_l', 'pages/run/maps/small_maps/fl_l.png');
    self.game.load.image('fl_ph_n', 'pages/run/maps/small_maps/fl.png');
    
    self.game.load.image('pc', 'pages/run/maps/small_maps/pc.png');
    self.game.load.image('pc_f', 'pages/run/maps/small_maps/pc_f.png');
    self.game.load.image('pc_l', 'pages/run/maps/small_maps/pc_l.png');
    self.game.load.image('pc_ph', 'pages/run/maps/small_maps/pc.png');
    self.game.load.image('pc_ph_f', 'pages/run/maps/small_maps/pc_f.png');
    self.game.load.image('pc_ph_l', 'pages/run/maps/small_maps/pc_l.png');
    ...
    self.game.load.image('tr_tl', 'pages/run/maps/small_maps/tr_tl.png');
    self.game.load.image('tr_tl_f', 'pages/run/maps/small_maps/tr_tl_f.png');
    self.game.load.image('tr_tl_ph', 'pages/run/maps/small_maps/tr_tl.png');
    self.game.load.image('tr_tl_ph_f', 'pages/run/maps/small_maps/tr_tl_f.png');
    
    self.game.load.image('tr_bl', 'pages/run/maps/small_maps/tr_bl.png');
    self.game.load.image('tr_bl_f', 'pages/run/maps/small_maps/tr_bl_f.png');
    self.game.load.image('tr_bl_ph', 'pages/run/maps/small_maps/tr_bl.png');
    self.game.load.image('tr_bl_ph_f', 'pages/run/maps/small_maps/tr_bl_f.png');
    
    self.game.load.image('tr_tr', 'pages/run/maps/small_maps/tr_tr.png');
    self.game.load.image('tr_tr_f', 'pages/run/maps/small_maps/tr_tr_f.png');
    self.game.load.image('tr_tr_ph', 'pages/run/maps/small_maps/tr_tr.png');
    self.game.load.image('tr_tr_ph_f', 'pages/run/maps/small_maps/tr_tr_f.png');
    
    self.game.load.image('tr_br', 'pages/run/maps/small_maps/tr_br.png');
    self.game.load.image('tr_br_l', 'pages/run/maps/small_maps/tr_br_l.png');
    self.game.load.image('tr_br_ph', 'pages/run/maps/small_maps/tr_br.png');
    self.game.load.image('tr_br_ph_l', 'pages/run/maps/small_maps/tr_br_l.png');
    
    
    self.game.load.image('wt', 'pages/run/maps/small_maps/wt.png');
    self.game.load.image('wt_n', 'pages/run/maps/small_maps/wt_n.png');
