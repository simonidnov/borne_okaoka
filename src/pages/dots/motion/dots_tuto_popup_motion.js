...
(lib.dots_hand_hit = function() {
	...
	// Calque 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(7).p("");
	this.shape.setTransform(-99.7,249.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFCC01").s().p("");
	this.shape_1.setTransform(-98.6,249.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#485DA7").s().p("");
	this.shape_2.setTransform(0,-45.7);
