...
(lib.dots_intro_triangle = function() {
	...
	// Calque 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ag9AtIA/hZIA8BZg");

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-6.2,-4.5,12.5,9.1);
...
(lib.dots_intro_rect = function() {
	...
	// Calque 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AmPAAIGPmOIGQGOImQGPg");

	this.addChild(this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-40,-40,80.1,80);
...
(lib.dots_motion_2 = function(mode,startPosition,loop) {
	...
	this.shape_16.graphics.f("#FFFFFF").s().p("AleFfQiSiSAAjNQAAjNCSiRQCSiSDMAAQDOAACRCSQCSCRAADNQAADNiSCSQiRCSjOAAQjMAAiSiSg");
	this.shape_16.setTransform(463.9,228.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#FFFFFF").ss(15,1,0,3).p("AnwAAQAAjNCRiSQCSiRDNAAQDNAACSCRQCSCSAADNQAADNiSCSQiSCSjNAAQjNAAiSiSQiRiSAAjNg");
	this.shape_17.setTransform(463.9,222.1);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#FFFFFF").s().p("AleFfQiSiRAAjOQAAjNCSiRQCSiSDMAAQDOAACRCSQCSCRAADNQAADOiSCRQiRCSjOAAQjMAAiSiSg");
	this.shape_18.setTransform(463.9,222.1);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#FFFFFF").ss(15,1,0,3).p("AnwAAQAAjMCRiSQCSiSDNAAQDNAACSCSQCSCSAADMQAADOiSCRQiSCSjNAAQjNAAiSiSQiRiRAAjOg");
	this.shape_19.setTransform(463.9,215.4);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#FFFFFF").s().p("AleFfQiSiRAAjOQAAjMCSiTQCSiRDMAAQDOAACRCRQCSCTAADMQAADOiSCRQiRCSjOAAQjMAAiSiSg");
	this.shape_20.setTransform(463.9,215.4);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#FFFFFF").s().p("AleFfQiSiRAAjOQAAjNCSiSQCSiRDMAAQDOAACRCRQCSCSAADNQAADOiSCRQiRCSjOAAQjMAAiSiSg");
	this.shape_21.setTransform(463.9,208.8);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("AleFfQiSiSAAjNQAAjNCSiSQCSiRDMAAQDOAACRCRQCSCSAADNQAADNiSCSQiRCSjOAAQjMAAiSiSg");
	this.shape_22.setTransform(463.9,202.1);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FFFFFF").s().p("AleFfQiSiSAAjNQAAjMCSiTQCSiRDMAAQDOAACRCRQCSCTAADMQAADNiSCSQiRCSjOAAQjMAAiSiSg");
	this.shape_23.setTransform(463.9,195.4);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#FFFFFF").s().p("AleFfQiSiSAAjNQAAjMCSiSQCSiSDMAAQDOAACRCSQCSCSAADMQAADNiSCSQiRCSjOAAQjMAAiSiSg");
	this.shape_24.setTransform(463.9,196.8);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#FFFFFF").s().p("AleFfQiSiRAAjOQAAjMCSiSQCSiSDMAAQDOAACRCSQCSCSAADMQAADOiSCRQiRCSjOAAQjMAAiSiSg");
	this.shape_25.setTransform(463.9,212.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_4}]}).to({state:[{t:this.instance_4}]},17).to({state:[{t:this.instance_4}]},7).to({state:[{t:this.instance_4}]},3).to({state:[{t:this.instance_4}]},11).to({state:[{t:this.instance_4}]},32).to({state:[{t:this.instance_4}]},9).to({state:[{t:this.instance_4}]},39).to({state:[{t:this.instance_4}]},6).to({state:[{t:this.shape}]},5).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7,p:{y:105.8}}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_7,p:{y:113.8}}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13,p:{y:159}}]},1).to({state:[{t:this.shape_14,p:{y:182.3}}]},1).to({state:[{t:this.shape_14,p:{y:205.5}}]},1).to({state:[{t:this.shape_15,p:{y:228.8}}]},1).to({state:[{t:this.shape_16,p:{y:228.8}},{t:this.shape_15,p:{y:228.8}}]},1).to({state:[{t:this.shape_18,p:{y:222.1}},{t:this.shape_17,p:{y:222.1}}]},1).to({state:[{t:this.shape_20},{t:this.shape_19,p:{y:215.4}}]},1).to({state:[{t:this.shape_21},{t:this.shape_14,p:{y:208.8}}]},1).to({state:[{t:this.shape_22,p:{y:202.1}},{t:this.shape_17,p:{y:202.1}}]},1).to({state:[{t:this.shape_23,p:{y:195.4}},{t:this.shape_13,p:{y:195.4}}]},1).to({state:[{t:this.shape_23,p:{y:188.8}},{t:this.shape_15,p:{y:188.8}}]},1).to({state:[{t:this.shape_24,p:{y:196.8}},{t:this.shape_14,p:{y:196.8}}]},1).to({state:[{t:this.shape_24,p:{y:204.8}},{t:this.shape_14,p:{y:204.8}}]},1).to({state:[{t:this.shape_25,p:{y:212.8}},{t:this.shape_14,p:{y:212.8}}]},1).to({state:[{t:this.shape_18,p:{y:220.8}},{t:this.shape_15,p:{y:220.8}}]},1).to({state:[{t:this.shape_22,p:{y:217.4}},{t:this.shape_19,p:{y:217.4}}]},1).to({state:[{t:this.shape_25,p:{y:214.1}},{t:this.shape_17,p:{y:214.1}}]},1).to({state:[{t:this.shape_16,p:{y:210.8}},{t:this.shape_15,p:{y:210.8}}]},1).to({state:[{t:this.shape_25,p:{y:214.1}},{t:this.shape_17,p:{y:214.1}}]},1).to({state:[{t:this.shape_22,p:{y:217.4}},{t:this.shape_19,p:{y:217.4}}]},1).to({state:[{t:this.shape_18,p:{y:220.8}},{t:this.shape_15,p:{y:220.8}}]},1).wait(39));
