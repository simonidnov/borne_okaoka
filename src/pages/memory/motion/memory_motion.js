...
(lib.runner = function(mode,startPosition,loop) {
	...
	this.shape_11.graphics.f().s("#FFFFFF").ss(5,1).p("AiTAPQA+guBNAZQBJAWBTge");
	this.shape_11.setTransform(-1.9,-21.7);

	this.timeline.addTween(cjs.Tween.get(this.shape_11).wait(3).to({y:-19.9},0).wait(3).to({y:-23.5},0).wait(3).to({y:-23.9},0).wait(3).to({y:-17.2},0).wait(3).to({y:-20.7},0).wait(3));
	...
	this.shape_12.graphics.f().s("#FFFFFF").ss(5,1).p("AAjCMIhmgMQgYgDgQgTQgPgTADgZIASiVQACgYAUgQQAUgPAYADIBmAMQAZADAQATQAPAUgDAYIgSCVQgDAZgTAPQgUAPgZgDg");
	this.shape_12.setTransform(1.8,-44);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_12,p:{x:1.8,y:-44}},{t:this.instance,p:{y:-16.4}}]}).to({state:[{t:this.shape_12,p:{x:0.5,y:-42.2}},{t:this.instance,p:{y:-18.6}}]},3).to({state:[{t:this.shape_12,p:{x:1.8,y:-46.2}},{t:this.instance,p:{y:-18.6}}]},3).to({state:[{t:this.shape_12,p:{x:1.8,y:-47.1}},{t:this.instance,p:{y:-19.5}}]},3).to({state:[{t:this.shape_12,p:{x:1.8,y:-39.9}},{t:this.instance,p:{y:-16.4}}]},3).to({state:[{t:this.shape_12,p:{x:1.8,y:-43.1}},{t:this.instance,p:{y:-15.5}}]},3).wait(3));
...
(lib.running = function(mode,startPosition,loop) {
	...
	this.shape_15.graphics.f().s("#FFFFFF").ss(5,1).p("Ah2ADQA6gIA9AFQA6ADA8gF");
	this.shape_15.setTransform(-0.9,-24.3);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#FFFFFF").ss(5,1).p("Ah+AGQA7gRBDALQA8AGBDgL");
	this.shape_16.setTransform(-1,-24.4);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#FFFFFF").ss(5,1).p("AiFAJQA9gbBIATQA+AIBIgR");
	this.shape_17.setTransform(-1.3,-24.6);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#FFFFFF").ss(5,1).p("AiMAMQA9glBPAaQA/AMBOgY");
	this.shape_18.setTransform(-1.4,-24.7);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#FFFFFF").ss(5,1).p("AiTAPQA+guBVAgQBBAPBTge");
	this.shape_19.setTransform(-1.7,-24.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_14}]},28).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[]},1).wait(219));
	...
	this.shape_21.graphics.f().s("#FFFFFF").ss(5,1).p("Ag/BSQBPhDAwhg");
	this.shape_21.setTransform(-6.5,-11.2);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("#FFFFFF").ss(5,1).p("AhBBJQBggrAihm");
	this.shape_22.setTransform(-7.3,-11.4);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("#FFFFFF").ss(5,1).p("AhCBAQBygUAUhs");
	this.shape_23.setTransform(-8.1,-11.6);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f().s("#FFFFFF").ss(5,1).p("AhFA3QCEAEAGhy");
	this.shape_24.setTransform(-8.9,-11.8);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("#FFFFFF").ss(5,1).p("AhGAsQCWAcgJh4");
	this.shape_25.setTransform(-9.8,-11.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_20}]},28).to({state:[{t:this.shape_21}]},1).to({state:[{t:this.shape_22}]},1).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[]},1).wait(219));
	...
	this.shape_27.graphics.f().s("#FFFFFF").ss(5,1).p("Ag0hWQBABIApBl");
	this.shape_27.setTransform(5.3,-10.7);

	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f().s("#FFFFFF").ss(5,1).p("Ag3hTQBQA1AfBy");
	this.shape_28.setTransform(5,-10.4);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f().s("#FFFFFF").ss(5,1).p("Ag6hQQBgAiAVB/");
	this.shape_29.setTransform(4.6,-10);

	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f().s("#FFFFFF").ss(5,1).p("Ag9hMQBvAPAMCK");
	this.shape_30.setTransform(4.3,-9.7);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f().s("#FFFFFF").ss(5,1).p("AhBhIQCAgFADCX");
	this.shape_31.setTransform(4,-9.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_26}]},28).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_28}]},1).to({state:[{t:this.shape_29}]},1).to({state:[{t:this.shape_30}]},1).to({state:[{t:this.shape_31}]},1).to({state:[]},1).wait(219));

	// Calque 8
	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f().s("#FFFFFF").ss(5,1).p("AA0CHIhnAAQgZAAgSgRQgRgSAAgZIAAiVQAAgZARgSQASgRAZAAIBnAAQAZAAASARQARASAAAZIAACVQAAAZgRASQgSARgZAAg");
	this.shape_32.setTransform(-0.6,-47.7);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f().s("#FFFFFF").ss(5,1).p("AhvhKQAAgZARgSQASgRAZAAIBnAAQAZAAASARQARASAAAZIAACVQAAAZgRASQgSARgZAAIhnAAQgZAAgSgRQgRgSAAgZg");
	this.shape_33.setTransform(-0.6,-47.7);
	this.shape_33._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_32}]},28).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_32}]},1).to({state:[]},1).wait(219));
	this.timeline.addTween(cjs.Tween.get(this.shape_33).wait(29).to({_off:false},0).wait(3).to({_off:true},1).wait(220));
	...
	this.shape_34.graphics.f("#FFFFFF").s().p("");
	this.shape_34.setTransform(3.3,-32.1);

	this.instance_3 = new lib.runner();
	this.instance_3.setTransform(-0.5,-31.6,1,1,0,0,0,-1.2,-29.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_34},{t:this.instance_2}]}).to({state:[]},28).to({state:[{t:this.instance_3}]},6).to({state:[]},174).wait(45));
...
(lib.memory_motion = function(mode,startPosition,loop) {
