...
gamepad.prototype.click = function(pointer) {
...
gamepad.prototype.release = function() {
    //self.game.physics.p2.removeConstraint(mouseConstraint);
}
gamepad.prototype.move = function(pointer) {
...
gamepad.prototype.collision = function(body, bodyB, shapeA, shapeB, equation){
    if(body){
...
gamepad.prototype.create_interface = function(){
...
gamepad.prototype.destroy = function(callBack){
    self.game.destroy();
    callBack();
}