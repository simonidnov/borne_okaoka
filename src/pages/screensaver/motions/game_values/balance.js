...
(lib.balance = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({_off:false},0).wait(96).to({x:-1084.7,startPosition:107},0).wait(340).to({regX:1540,regY:43.4,x:455.3,y:355,startPosition:447},0).to({regY:43.5,rotation:-3.2,y:355.1,startPosition:455},8).to({rotation:3.5,startPosition:462},7).to({rotation:0,startPosition:470},8).to({rotation:-3.2,x:455.2,startPosition:487},17).to({rotation:3.5,x:455.3,startPosition:462},23).to({rotation:0,startPosition:470},27).wait(40));
